...
public class Items {
	...
	private void initItems() {
		...
		for(int i = 1; i < 35; i++){
			if (Paintball.cfg.isSet("Items."+i)){
				...
				if (Paintball.cfg.isSet("Items."+i+".Power")){
					item.setPower(Paintball.cfg.getInt("Items."+i+".Power"));
				}
				if (Paintball.cfg.isSet("Items."+i+".Permission")){
					item.setPermission(Paintball.cfg.getString("Items."+i+".Permission"));
				}
				if (Paintball.cfg.isSet("Items."+i+".Cooldown")){
					item.setCooldown(Paintball.cfg.getInt("Items."+i+".Cooldown"));
				}
				if (Paintball.cfg.isSet("Items."+i+".Shots")){
					item.setShots(Paintball.cfg.getInt("Items."+i+".Shots"));
				}
				if (Paintball.cfg.isSet("Items."+i+".Spread")){
					item.setSpread(Paintball.cfg.getDouble("Items."+i+".Spread"));
				}
				if (Paintball.cfg.isSet("Items."+i+".Speed")){
					item.setSpeed(Paintball.cfg.getDouble("Items."+i+".Speed"));
				}
				items.put(i, item);
	...
	public static ItemStack getOptIn() {
		...
		if (Paintball.cfg.isSet("Items.OPTIN.Permission")){
			item.setPermission(Paintball.cfg.getString("Items.OPTIN.Permission"));
		}
		if (Paintball.cfg.isSet("Items.OPTIN.Cooldown")){
			item.setCooldown(Paintball.cfg.getInt("Items.OPTIN.Cooldown"));
		}
		items.put(1000, item);
	...
	public static ItemStack getOptOut() {
		...
		if (Paintball.cfg.isSet("Items.OPTOUT.Permission")){
			item.setPermission(Paintball.cfg.getString("Items.OPTOUT.Permission"));
		}
		if (Paintball.cfg.isSet("Items.OPTOUT.Cooldown")){
			item.setCooldown(Paintball.cfg.getInt("Items.OPTOUT.Cooldown"));
		}
		items.put(1001, item);
		return item.getItemStack();
	}
